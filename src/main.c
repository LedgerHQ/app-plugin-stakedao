...
static const uint8_t STAKEDAO_OPT_DEPOSIT_UNDERLYING_SELECTOR[SELECTOR_SIZE] = {0x4d,
                                                                                0x56,
                                                                                0x93,
                                                                                0xab};
...
static const uint8_t STAKEDAO_OPT_WITHDRAW_UNDERLYING_SELECTOR[SELECTOR_SIZE] = {0xc2,
                                                                                 0x2f,
                                                                                 0xb4,
                                                                                 0xef};
...
static const uint8_t STAKEDAO_CURVE_ADD_LIQUIDITY_2_SELECTOR[SELECTOR_SIZE] = {0x0b,
                                                                               0x4c,
                                                                               0x7e,
                                                                               0x4d};
// function add_liquidity(uint256[3],uint256)
static const uint8_t STAKEDAO_CURVE_ADD_LIQUIDITY_3_SELECTOR[SELECTOR_SIZE] = {0x45,
                                                                               0x15,
                                                                               0xce,
                                                                               0xf3};
// function add_liquidity(uint256[3],uint256,uint256)
static const uint8_t STAKEDAO_CURVE_ADD_LIQUIDITY_3_UNDER_SELECTOR[SELECTOR_SIZE] = {0x2b,
                                                                                     0x6e,
                                                                                     0x99,
                                                                                     0x3a};

const uint8_t STAKEDAO_NFT_BOOST[ADDRESS_LENGTH] = {0xa3, 0x24, 0xa2, 0xe3, 0xa6, 0xf6, 0x4b,
                                                    0xd5, 0x88, 0x56, 0x5e, 0x0e, 0x1e, 0x2d,
                                                    0xd5, 0x0e, 0x7a, 0x68, 0xbd, 0xd9};
